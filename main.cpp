...
#include <windows.h>
#include <cmath>
/*Это 8 вариант,то есть не мой,я надеюсь,что ругать не будете,если я буду делать сво1,я потрачу млн времени и не факт,что сделаю,мне хоть бы теорию выучить,и все равно лектор будет спрашивать только теорию
поэтому да,я надеюсь,что вы примите данное решение*/
